    ...
    def train_step(self,useless_argument,show=False):
        ...
        for _ in range(self.disc_iter) :
            ...
            with tf.GradientTape() as tape:
                ...
                discr_loss = self.discriminator.loss(self.discr_return_on_real, self.discr_return_on_fake)
        ...
        return {"discr_loss": discr_loss, "gen_loss": gen_loss,}#"discr_return_on_fake_g":discr_return_on_fake_g, "discr_return_on_real":discr_return_on_real, "discr_return_on_fake":discr_return_on_fake}
